(function() {
    ...
    function setupToolButtons() {
        ...
        // Speak / Stop button with deep voice
        ...
        if (speakBtn) {
            speakBtn.onclick = () => {
                ...
                // Attempt to set a deep male voice after voices are loaded
                const setDeepVoice = () => {
                    ...
                    if (deepVoice) speechUtterance.voice = deepVoice;
                };
                if (window.speechSynthesis.getVoices().length > 0) {
                    setDeepVoice();
                } else {
                    window.speechSynthesis.onvoiceschanged = setDeepVoice;
                }
